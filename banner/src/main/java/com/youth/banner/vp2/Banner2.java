...
public class Banner2<T> extends FrameLayout {
    ...
    public Banner2(@NonNull Context context) {
        this(context, null);
    }

    public Banner2(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Banner2(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
